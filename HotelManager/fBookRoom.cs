...
namespace HotelManager
{
    public partial class fBookRoom : Form
    {
        ...
        {
            if (MetroFramework.MetroMessageBox.Show(this, "Bạn có muốn đặt phòng không?", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                if (txbIDCard.Text != String.Empty && txbFullName.Text != String.Empty && txbAddress.Text != String.Empty && txbPhoneNumber.Text != String.Empty && cbNationality.Text != String.Empty)
                {
                    ...
                    MetroFramework.MetroMessageBox.Show(this, "Vui lòng nhập đầy đủ thông tin.", "Cảnh báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }   
        }
        ...
        private void txbIDCardSearch_OnValueChanged(object sender, EventArgs e)
        {
