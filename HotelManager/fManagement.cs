...
namespace HotelManager
{
    public partial class fManagement: Form
    {
        ...
        {
            if (MetroFramework.MetroMessageBox.Show(this, "Bạn có muốn thoát không?", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                Application.Exit();
        }
        ...
        private void titleManageRoom_Click(object sender, EventArgs e)
        {
            if (IsAdmin())
            {
                ...
                MetroFramework.MetroMessageBox.Show(this, "Bạn không quyền truy cập.", "Cảnh báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
